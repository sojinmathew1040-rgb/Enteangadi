...
function renderProductCard($product, $baseUrl, $isGuest = true) {
...
if (!function_exists('isOrUnderCategory')) {
        ...
        <?php else: ?>
            <div class="product-grid">
                <?php foreach ($products as $product) {
                    echo renderProductCard($product, $base_url, true);
                } ?>
            </div>
        <?php endif; ?>
