    ...
    <div
        ...
        <div style="border-bottom: 1px solid #eee;">
            <button type="button"
                ...
                <span style="font-weight: 500; flex: 1; color: var(--text-dark);">Change Password</span>
                <i class="fa fa-chevron-down" style="color: #ccc; font-size: 12px;"></i>
            </button>
            <div id="change-pw-form" style="display: none; padding: 0 20px 20px 56px;">
                <form method="POST" action="settings.php">
                    ...
                    <button type="submit" class="btn-primary"
                        style="padding: 8px 16px; font-size: 14px; border-radius: 8px;">Update Password</button>
                </form>
            </div>
        </div>
...
<div id="closureModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6); z-index: 10000; align-items: center; justify-content: center; backdrop-filter: blur(4px);">
    <div style="background: white; padding: 32px; border-radius: 24px; width: 90%; max-width: 400px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04);">
        <h3 style="margin-bottom: 8px; font-size: 20px; font-weight: 800; color: var(--text-dark);">Close Account?</h3>
        <p style="color: var(--text-muted); font-size: 14px; margin-bottom: 24px;">We're sorry to see you go. Please tell us why you are leaving.</p>
        
        <form method="POST" id="closureForm">
            <input type="hidden" name="action" value="delete_account">
            
            <div class="form-group" style="margin-bottom: 20px;">
                <label style="font-size: 11px; font-weight: 700; color: var(--text-muted); margin-bottom: 12px; display: block; text-transform: uppercase;">Select a reason</label>
            ...
            <div id="customClosureWrapper" style="display: none; margin-bottom: 20px;">
                <label style="font-size: 11px; font-weight: 700; color: var(--text-muted); margin-bottom: 8px; display: block; text-transform: uppercase;">Please specify</label>
                <textarea name="custom_reason" class="form-control" rows="3" placeholder="Tell us more..." style="font-size: 14px; border-radius: 12px;"></textarea>
            </div>

            <div style="display: flex; gap: 12px; margin-top: 32px;">
                <button type="button" onclick="closeClosureModal()" class="btn-secondary" style="flex: 1; padding: 12px; border-radius: 12px; font-weight: 600;">Cancel</button>
                <button type="submit" class="btn-primary" style="flex: 2; padding: 12px; border-radius: 12px; font-weight: 700; background: #ef4444; border-color: #ef4444;">Delete Permanently</button>
            </div>
        </form>
    </div>
</div>
