...
<div class="container">
    ...
    <?php if (empty($products)): ?>
        <div
            ...
            <a href="post_ad.php" class="btn-primary" style="display: inline-block; margin-top: 16px;">Post an Ad</a>
        </div>
    <?php else: ?>
        <h2 style="color: var(--primary-green-dark); font-size: 28px; font-weight: 700; margin-bottom: 24px;">Fresh
            Recommendations</h2>
